...
default_data = {
    ...
    'web64': {
        ...
        'github': 'https://github.com/mikeweb85/nlpserver',
        'endpoints': [
            '/status',
            '/gensim/summarize',
            '/polyglot/neighbours',
    ...
    'message': 'NLP Server by web64.com'
}
...
def spacy_entities():
    ...
    data = dict(default_data)
    data[
        'message'] = "Spacy.io Entities (NER) - Usage: 'text' POST parameter, 'lang' POST parameter for Spacy model (lang=en by default)"
    params = {}
    ...
    nlp = spacy.load(data['language_map'][lang])
    doc = nlp(params['text'])
    data['entities'] = {}
